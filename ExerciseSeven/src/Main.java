public class Main {
    ...
    private static void exercise1() {
        ...
        ourNumberInt+=2;
        String ourNewNumberStr = String.valueOf(ourNumberInt);
        System.out.println(ourNewNumberStr);
    }

    /**
     * 2a: Convert ourChar to a String, make it uppercase
     * <p>
     * 2b: Play around line 41, experiment the integer of 0 to a number where it prints 'w', instead of 'H'
     * think about what the charAt method is doing?
     */
    private static void exercise2() {
        System.out.println("\nExercise 2a:");
        char ourChar = 'a';
        String ourCharString = Character.toString(ourChar);
    ...
    private static void exercise4() {
        System.out.println("\nExercise 4:");
        String startStr = "5 ";
        int starStrToInt = Integer.valueOf(startStr.trim());
        starStrToInt*=2;
        String newStr = String.valueOf(starStrToInt);
        newStr+=newStr;
        double newStrToDouble = Double.valueOf(newStr);
        newStrToDouble/=3.5;
        System.out.println(Math.floor(newStrToDouble));
    }
}